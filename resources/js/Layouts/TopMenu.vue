<template>
    <header class="z-10 py-4 bg-white shadow-md border-4 border-b-lightgray">
      <div class="container flex justify-between items-center px-6 mx-auto h-full text-darkgreen md:justify-end">
        <!-- Mobile hamburger -->
        ...
        <Dropdown>
          <template #trigger>
            <button class="align-middle rounded-full focus:shadow-outline-darkgreen focus:outline-none" aria-label="Account" aria-haspopup="true">
